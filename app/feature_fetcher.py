    ...
    try:
        ...
        feature_vector = store.get_online_features(
            features=[
                ...
                "user_batch_fv_v1:user_txn_count_5m",
                "user_batch_fv_v1:user_txn_count_10m",
                "user_batch_fv_v1:user_txn_count_1h",
                "user_batch_fv_v1:user_txn_amount_sum_5m",
                "user_batch_fv_v1:user_txn_amount_sum_10m",
                "user_batch_fv_v1:user_txn_amount_sum_1h",
                "user_batch_fv_v1:user_distinct_merchants_5m",
                "user_batch_fv_v1:user_distinct_merchants_10m",
                "user_batch_fv_v1:user_distinct_merchants_1h",
                "user_batch_fv_v1:user_failed_logins_15m",
                "user_batch_fv_v1:user_failed_logins_1h",
                "device_batch_fv_v1:device_txn_count_5m",
                "device_batch_fv_v1:device_txn_count_10m",
                "device_batch_fv_v1:device_txn_count_1h",
            ],
